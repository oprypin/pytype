...
# such as "test_all_shard_1_of_4".
add_custom_target("test_all")

set(ALL_TESTS_SHARD_COUNT 4)
foreach(i RANGE 1 ${ALL_TESTS_SHARD_COUNT})
  add_custom_target("test_all_shard_${i}_of_${ALL_TESTS_SHARD_COUNT}")
endforeach()

# Add a target to "test_all" and to its its computed "test_all_shard_*" target.
...
function(genbison)
  ...
  if(NOT GENBISON_NAME)
    message(FATAL_ERROR "'genbison' rule requires a NAME argument specifying the target name.")
  endif()
  if(NOT GENBISON_SRC)
    message(FATAL_ERROR "'genbison' rule requires a SRC argument specifying the .yy file.")
  endif()
  if(NOT GENBISON_HDR_OUT)
    message(FATAL_ERROR "'genbison' rule requires a HDR_OUT argument specifying the name of the generated header file.")
  endif()
  if(NOT GENBISON_CC_OUT)
    message(FATAL_ERROR "'genbison' rule requires a CC_OUT argument specifying the name of the generated .cc file.")
  endif()
...
function(py_test)
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E env TYPESHED_HOME=${PROJECT_SOURCE_DIR}/typeshed ${PYTHON_EXECUTABLE} -B
